<?php
// on l'ignore, on en parlera dans la partie 2
namespace Cours\POO;
/*
...
class Asus implements Ordinateur
{
    ...
    function youtube($u)
    {
        echo "Je regarde $u <br>";
    }
    function excel()
    {
        echo "Je travaille sur Excel <br>";
    }
}
$pc = new Asus();
$pc->description();
